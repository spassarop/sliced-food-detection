...
namespace SlicesClassifier.Models
{
    public static class ModelBuilder
    {
        ...
        public static void CreateModel(ImageClassificationTrainer.Options options, string trainDataFilePath)
        {
            ModelInput.SetDataBasePath(trainDataFilePath);
            ...
            IEstimator<ITransformer> trainingPipeline = BuildTrainingPipeline(mlContext, options);
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext, ImageClassificationTrainer.Options options)
        {
